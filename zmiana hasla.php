	...
	<main>
		<div class="container-fluid">
			...
			<div class="row col-sm-8 offset-sm-2 col-lg-6 offset-lg-3 justify-content-center">
				<form action="finanse-osobiste?action=changePassword"  method="post">
					...
					<input type="password" name="password1" placeholder="podaj nowe hasło" onfocus="this.placeholder=''" onblur="this.placeholder='hasło'">
					...
					<input type="password" name="password2" placeholder="potwierdź hasło" onfocus="this.placeholder=''" onblur="this.placeholder='potwierdź hasło'">			
